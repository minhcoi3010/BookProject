...
public class BookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            //lấy sách ra theo tên list sách và khoá key sách
            if (keyBook != null) {
                Book book;
                ...
                //kiểm tra xem có yêu thích hay không
                ...
                //kiểm tra xem có yêu thích hay không
                //nếu có thì thêm sách đó vào list yêu thích
                starImage.setOnClickListener(view -> {
                    //chuyển đổi giữa yêu thích và ngược lại
